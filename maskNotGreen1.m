function [BW,maskedRGBImage] = maskNotGreen1(RGB)
...
shiftVec = [86.292904 120.910248 77.097022];
I = I - shiftVec;
I = [I ones(size(I,1),1)]';

% Apply transformation matrix
tMat = [0.002826 0.001123 0.000000 -0.627390;
    -0.000103 0.000411 0.002792 -0.534331;
    -0.000887 0.003532 -0.000325 8.394980;
...
hPoints(1).data = [-0.029151 -0.068169;
    -0.363760 -0.435108;
    -0.531064 -0.547436;
    -0.602041 -0.633555;
    -0.579227 -0.708440;
